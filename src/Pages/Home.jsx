  ...
  return (
    <main className="flex-grow">
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        variants={fadeInUp}
        className="max-w-6xl mx-auto py-20 px-6 rounded-3xl shadow-xl overflow-hidden
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center max-w-5xl mx-auto">
          <motion.div variants={fadeInUp}>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
              ...
              <span className="text-cyan-600 dark:text-cyan-400">finances</span>
            </h1>
      ...
      >
        <h2 className="text-center text-3xl font-bold text-cyan-600 dark:text-cyan-400 mb-10">
          Overview
        </h2>
      ...
      >
        <motion.div
          variants={fadeInUp}
          className="col-span-2 p-8 rounded-2xl shadow-lg bg-cyan-50 dark:bg-cyan-900/30 hover:-translate-y-2 transition"
        >
          <h3 className="text-2xl font-bold text-cyan-600 dark:text-cyan-400 mb-4">
            Budgeting Tips
          </h3>
        ...
        <motion.div
          variants={fadeInUp}
          className="p-6 rounded-2xl shadow-lg bg-white dark:bg-[#0A0A0A] border border-cyan-200 dark:border-cyan-700 hover:-translate-y-2 transition"
        >
