...
const AddTransaction = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log({ ...formData, userEmail: user?.email, userName: user?.displayName });
    };

    return (
        <div className="max-w-4xl mx-auto p-6">
            <h1 className="text-3xl font-bold text-center mb-8 text-blue-600">Add New Transaction</h1>
